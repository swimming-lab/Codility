...
public class String_72410 {
    ...
    public static void main(String[] args) {
        final String_72410 solution = new String_72410();
        String result1 = solution.solution1("...!@BaT#*..y.abcdefghijklm");
        System.out.println(result1);

        String result2 = solution.solution2("abcdefghijklmn.p");
//        String result2 = solution.solution2("...!@BaT#*..y.abcdefghijklm");
